...
class YOLO():
    ...
    def forward(self, inputs, isTrain=True):
        ...
        feature_y3 = module.conv(net, 3*(self.class_num+4+1), kernel_size=1, bn=False, activation=None, isTrain=isTrain)
        ...
        feature_y2 = module.conv(net, 3*(self.class_num + 4 + 1), kernel_size=1, bn=False, activation=None, isTrain=isTrain)
        ...
        feature_y1 = module.conv(net, 3*(self.class_num + 4 + 1), kernel_size=1, bn=False, activation=None, isTrain=isTrain)
